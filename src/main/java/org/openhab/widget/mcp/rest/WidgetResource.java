...
public class WidgetResource {
  ...
  @Operation(
      ...
      description = "Returns all custom widgets registered in OpenHAB.")
  ...
  public Response getWidget(
      @Parameter(description = "Widget UID, e.g. RD_car_charging_widget") @PathParam("uid")
          String uid) {
  ...
  @Operation(
      summary = "Upload a widget YAML file",
      description =
          "Creates or updates a widget by uploading a YAML file. Use the Swagger UI file picker or curl -F.")
  public Response uploadWidget(@RestForm("file") FileUpload file) {
    ...
    try {
      ...
      WidgetService.CreateOrUpdateWidget result =
          widgetService.createOrUpdateWidgetFromYaml(yamlContent);
  ...
  @Operation(
      summary = "Create or update widget from YAML string",
  ...
  public Response deleteWidget(
      @Parameter(description = "Widget UID to delete") @PathParam("uid") String uid) {
  ...
  @Produces("image/png")
  @Operation(
      summary = "Screenshot widget preview",
      description =
          "Opens the widget in the OpenHAB developer UI, optionally sets props, and returns a PNG screenshot.")
  public Response screenshotWidget(
      @Parameter(description = "Widget UID") @PathParam("uid") String uid,
      @Parameter(
              description =
                  "JSON props object, e.g. {\"title\":\"Auto\"}. Leave empty for no props.")
          @QueryParam("props")
          String propsJson) {
