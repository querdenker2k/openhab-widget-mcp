...
public class ImageUtil {
     ...
     *
     * @param image      Das zu prüfende Bild
     * @param tolerance  Erlaubte Abweichung von 255 (z. B. 5 → erlaubt 250–255)
     * @param checkAlpha Ob Transparenz berücksichtigt werden soll (true = Pixel muss voll sichtbar sein)
