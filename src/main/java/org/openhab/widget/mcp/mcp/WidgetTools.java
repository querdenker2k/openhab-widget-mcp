...
public class WidgetTools {
  ...
  @Tool(
      description =
          "Upload a widget to OpenHAB from a YAML file on the server filesystem. "
  ...
  public WidgetService.CreateOrUpdateWidget createOrUpdateWidget(
      @ToolArg(
              description =
                  "Absolute path to the widget YAML file, e.g. /home/robert/VSCode Projects/main-ui-widgets/RD_MyWidget.yaml")
          String filePath) {
  ...
  public String previewWidget(
      ...
      @ToolArg(
              ...
              defaultValue = "{}",
              description =
                  "JSON object with widget props to set before screenshotting, "
