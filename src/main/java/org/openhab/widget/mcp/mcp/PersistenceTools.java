...
public class PersistenceTools {
	...
	public String addPersistenceData(@ToolArg(description = "The name of the item to add data for") String itemName,
			@ToolArg(description = "The timestamp for the data point, e.g. 2023-10-27T10:00:00Z. "
					+ "Must be in ISO 8601 format.") String time,
