...
public class ItemService {
  ...
  public String listItems(String nameFilter) {
    ...
    try {
      ...
      if (status == 401 || status == 403) {
        return "Error listing items: HTTP "
            + status
      ...
      List<Map<String, Object>> filtered =
          items.stream()
              ...
              .toList();
      log.info(
          "listItems: HTTP {}, {}/{} items match filter '{}'",
          status,
          filtered.size(),
          items.size(),
          nameFilter);
  ...
  public String sendItemCommand(String itemName, String command) {
    ...
    try {
      ...
      log.warn(
          "sendItemCommand: unexpected HTTP {} for item={} command={}", status, itemName, command);
  ...
  public String createItem(
      String name, String type, String label, String category, List<String> groups) {
  ...
  public String setItemMetadata(
      String name, String namespace, String value, Map<String, Object> config) {
  ...
  public String deleteItemMetadata(String name, String namespace) {
    ...
    try {
      ...
      return "Error removing metadata '"
          + namespace
          + "' from '"
          + name
          + "': HTTP "
