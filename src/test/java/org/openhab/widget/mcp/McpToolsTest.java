...
/**
 * Tests MCP tools in two ways:
 * 1. Direct CDI injection — verifies business logic against a real OpenHAB instance.
 * 2. SSE transport endpoint — verifies /mcp/sse is reachable and streams events.
 */
@QuarkusTest
