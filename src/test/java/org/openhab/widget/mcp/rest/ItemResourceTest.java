...
class ItemResourceTest {
  ...
  void sendItemCommand_acceptsCommand() {
    given()
        ...
        .body("ON")
        .when()
        .post("/api/items/TestSwitch/command")
        .then()
        .statusCode(200)
  ...
  void sendItemCommand_unknownItem_returnsNotFoundMessage() {
    given()
        ...
        .body("ON")
        .when()
        .post("/api/items/GhostItem/command")
        .then()
        .statusCode(200)
