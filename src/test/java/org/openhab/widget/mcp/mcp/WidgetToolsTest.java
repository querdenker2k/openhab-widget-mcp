...
public class WidgetToolsTest {
    ...
    static void createOrUpdateWidget(McpAssured.McpStreamableTestClient client, WidgetService.CreateOrUpdateState state) {
        client.when()
                .toolsCall("createOrUpdateWidget",
    ...
    void testPreviewWidget() {
        ...
        ImageTestUtil.compareWithReference(new File(res), FileUtils.toFile(IOUtils.resourceToURL("/ref/widget_TestWidget.png")));
    }
